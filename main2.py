...
class PizzaSelector:
    ...
    def submit(self):
        ...
        print(
            f"Asserting UserSelection with drink={selected_drink}, pizza={selected_pizza}, promotion={selected_promotion}")
        self.env.assert_string(
            f'(UserSelection (drink {selected_drink}) (pizza {selected_pizza}) (promotion {selected_promotion}))')
